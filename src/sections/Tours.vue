      ...
      <div class="relative group/nav">
        ...
        >
          <article
            v-for="tour in tours"
            :key="tour.slug"
            class="w-[80vw] md:w-[calc((100%-2rem)/3)] snap-start flex-shrink-0 bg-brand-card rounded-2xl overflow-hidden group transition-all duration-300 border border-brand-cream/15 hover:border-brand-cream/25"
          >
            <!-- Image -->
            ...
            <div class="p-5">
              ...
              <div v-if="!esDefinir(tour)" class="flex items-center gap-1 mb-4 text-xs text-brand-cream/60 font-sans">
              ...
              <div class="flex items-baseline gap-2 mb-5">
                <span v-if="esDefinir(tour)" class="text-brand-cream/60 font-heading text-2xl">
                  Próximamente
                </span>
                <template v-else>
              ...
              <button
                v-else
                disabled
                class="w-full border-2 border-brand-cream/10 text-brand-cream/40 rounded-lg py-2.5 font-sans font-semibold cursor-not-allowed text-sm"
              >
                Próximamente
              </button>
            </div>
