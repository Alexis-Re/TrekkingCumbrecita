    ...
    <div class="relative z-10 flex flex-col items-center text-center px-6 lg:px-16 max-w-3xl mx-auto pt-20 md:pt-16 pb-10 md:pb-6">
      ...
      >
        <a
          ...
          class="w-11 h-11 rounded-full border border-brand-cream/30 flex items-center justify-center hover:bg-brand-orange/20 hover:border-brand-orange/50 active:bg-brand-orange/20 active:border-brand-orange/50 active:scale-95 transition-all duration-300"
        >
